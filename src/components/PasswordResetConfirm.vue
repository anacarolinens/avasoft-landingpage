<template>
    <div class="container-reset flex flex-col items-center max-w-full pt-1">
      ...
      <form @submit.prevent="handlePasswordReset" class="w-full max-w-md">
  ...
  export default {
    data() {
      return {
        resetToken: this.$route.params.resetToken, // Pegando o token da URL
        newPassword: '',
        confirmPassword: '',
      };
    },
  ...
  <style scoped>
  /* Aqui você pode adicionar estilos customizados */
  </style>
<template>
    <div class="container-reset flex flex-col items-center max-w-full pt-1">
      <!-- Logo da Avasoft -->
